  ...
  return (
    <div className="mt-40 mb-20 lg:px-0 md:px-5 sm: px-3 mx-auto">
      ...
      <div className="relative">
        <div className="relative">
          <Image className="w-[600px] rounded-md shadow-md shadow-[#F26626]" src={storeImage2} alt="store image" />
        </div>
        <Image className="absolute top-[-40px] right-[300px] w-[350px] rounded-md shadow-md shadow-[#F26626] lg:block md:hidden sm: hidden" src={storeImage1} alt="store image" />
      </div>
      {/* content section  */}
      <div>
